...
public class MainMenu {
	...
	public MainMenu() {
	    ...
	    JLabel background = new JLabel(new ImageIcon(getClass().getResource("/GIF/backgroungMenu.gif")));
	    ...
	    JButton startBtn = createButton("START", new Color(0, 150, 0, 150));
	    JButton exitBtn = createButton("EXIT", new Color(150, 0, 0, 150));
	...
	private JButton createHelpButton() {
	    ...
	    helpBtn.setBackground(new Color(40, 40, 80, 200));
    ...
    private void trainer() {
        ...
        card1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
            	...
            	Pokedatnis.pokemoni.add(new ElektriskaisP());  
            	Pokedatnis.pokemoni.add(new UdensP());
